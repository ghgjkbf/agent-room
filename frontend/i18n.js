...
const STR = {
  ...
  'skills.src.zcode': ['ZCode 技能库（需设 AGENT_ROOM_SKILLS_ZCODE）', 'ZCode skill library (set AGENT_ROOM_SKILLS_ZCODE)'],
  'skills.src.trae': ['TRAE 技能库（需设 AGENT_ROOM_SKILLS_TRAE）', 'TRAE skill library (set AGENT_ROOM_SKILLS_TRAE)'],
  'skills.src.builtin': ['TRAE 内置技能（需设 AGENT_ROOM_SKILLS_TRAE_BUILTIN）', 'TRAE built-in skills (set AGENT_ROOM_SKILLS_TRAE_BUILTIN)'],
